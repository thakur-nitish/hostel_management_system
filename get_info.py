...
class GetInfo:
    def __init__(self, root):
        ...
        self.bg = PhotoImage(file="images/hostel3.png")
        ...
        # display message
        self.label = Label(top, font=('arial', 50, 'bold'), text="INFORMATION OF GUEST", fg="#15d3ba",
                           anchor="center")
        ...
        self.home_button = Button(button_frame, text="HOME", font=('', 15), bg="#15d3ba", relief=RIDGE, height=2,
                                  width=15, fg="black", anchor="center", command=lambda: self.root.destroy())
